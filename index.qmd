...
function forceCarousel(id) {
  ...
  var gap = 24;
  var cardWidth = Math.floor((availWidth - 2 * gap) / 3);
  var wrapperWidth = (3 * cardWidth) + (2 * gap);
  ...
  var cols = wrapper.querySelectorAll('.g-col-1');
...
function scrollListing(id, dir) {
  ...
  var visible = Math.round(wrapper.offsetWidth / colWidth);
