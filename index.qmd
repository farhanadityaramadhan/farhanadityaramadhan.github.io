...
- id: blog
  contents: 
    - webpages/projects/blog/
    - webpages/projects/blog.yml
  sort: "date desc"
  type: grid
  grid-columns: 3
  image-height: 150px
...
<script>
  /* Delegate clicks on the decorative search bar to Quarto's real search UI */
  document.addEventListener('DOMContentLoaded', function () {
    var trigger = document.getElementById('index-search-trigger');
    if (!trigger) return;
    trigger.addEventListener('click', function () {
      var btn = document.querySelector(
        '.aa-DetachedSearchButton, #quarto-search button, [data-bs-toggle=search]'
      );
      if (btn) {
        btn.click();
      } else {
...
<section class="hero-section">
  <div class="content-block">
    <div class="hero-label">Economics · Data · Research</div>
...
<div class="mywork-section">
  ...
  <div class="mywork-strip" id="mywork-strip">
    ...
    <!-- Divider between Projects and Resources -->
    ...
    <!-- Divider between Resources and Graphics -->
    <div class="mywork-divider"></div>
...
(function () {
  ...
  /* Debounced resize — recalculate card widths and restore position */
  var puResizeTimer;
